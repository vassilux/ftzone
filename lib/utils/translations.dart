...
/// Preferences related
///
const String _storageKey = "ftzone_";
...
class TranslationsDelegate extends LocalizationsDelegate<GlobalTranslations> {
  ...
  @override
  Future<GlobalTranslations> load(Locale locale) => GlobalTranslations.load(locale);

  @override
  bool shouldReload(TranslationsDelegate old) => false;
}

class SpecificLocalizationDelegate extends LocalizationsDelegate<GlobalTranslations> {
  ...
  @override
  Future<GlobalTranslations> load(Locale locale) => GlobalTranslations.load(overriddenLocale);

  @override
  bool shouldReload(LocalizationsDelegate<GlobalTranslations> old) => true;
}
...
class GlobalTranslations {
  ...
  static Future<GlobalTranslations> load(Locale locale) async {
